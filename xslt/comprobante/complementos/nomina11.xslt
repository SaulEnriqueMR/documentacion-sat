...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="nomina:Nomina">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de Nómina -->
    ...
    <xsl:choose>
      ...
      <xsl:when test="./@Version='1.0'">
        ...
        <!--Iniciamos
        el tratamiento de los atributos de Ingresos -->
        ...
        <!--Iniciamos
        el tratamiento de los atributos de descuentos -->
      ...
      <xsl:when test="./@Version='1.1'">
        ...
        <!--Iniciamos
        el tratamiento de los elementos de Nómina -->
  ...
  <xsl:template match="nomina:Percepciones">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de Percepciones -->
    ...
    <!--Iniciamos
    el tratamiento del los elementos de Percepciones-->
  ...
  <xsl:template match="nomina:Percepcion">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de Percepcion -->
  ...
  <xsl:template match="nomina:Deducciones">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de Deducciones -->
    ...
    <!--Iniciamos
    el tratamiento del los elementos de Deducciones-->
  ...
  <xsl:template match="nomina:Deduccion">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de Deduccion -->
  ...
  <xsl:template match="nomina:Incapacidades">
    ...
    <!--Iniciamos
    el tratamiento del los elementos de Incapacidades-->
  ...
  <xsl:template match="nomina:Incapacidad">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de Incapacidad -->
  ...
  <xsl:template match="nomina:HorasExtras">
    ...
    <!--Iniciamos
    el tratamiento del los elementos de HorasExtras-->
  ...
  <xsl:template match="nomina:HorasExtra">
    ...
    <!--Iniciamos
    el tratamiento de los atributos de HorasExtra -->
    <xsl:call-template name="Requerido">
