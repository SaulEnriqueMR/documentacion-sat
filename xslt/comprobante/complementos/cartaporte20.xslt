...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="cartaporte20:Mercancias">
		<!--Manejador
		de nodos tipo cartaporte20:Mercancias-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte20:Mercancia">
		<!--Manejador
		de nodos tipo cartaporte20:Mercancia-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte20:Autotransporte">
		<!--Manejador
		de nodos tipo cartaporte20:Autotransporte-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte20:TransporteMaritimo">
		<!--Manejador
		de nodos tipo cartaporte20:TransporteMaritimo-->
		<xsl:call-template name="Opcional">
			<xsl:with-param name="valor" select="./@PermSCT" />
		</xsl:call-template>
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte20:TransporteAereo">
		<!--Manejador
		de nodos tipo cartaporte20:TransporteAereo-->
		<xsl:call-template name="Requerido">
			<xsl:with-param name="valor" select="./@PermSCT" />
		</xsl:call-template>
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte20:TransporteFerroviario">
		<!--Manejador
		de nodos tipo cartaporte20:TransporteFerroviario-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte20:Carro">
		<!--Manejador
		de nodos tipo cartaporte20:Carro-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte20:FiguraTransporte">
		<!--Manejador
		de nodos tipo cartaporte20:FiguraTransporte-->
	...
	<xsl:template match="cartaporte20:PartesTransporte">
		<!--Manejador
		de nodos tipo cartaporte20:PartesTransporte-->
		<xsl:call-template name="Requerido">
