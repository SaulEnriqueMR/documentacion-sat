...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="cartaporte31:Mercancias">
		<!--Manejador
		de nodos tipo cartaporte31:Mercancias-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte31:Mercancia">
		<!--Manejador
		de nodos tipo cartaporte31:Mercancia-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte31:Autotransporte">
		<!--Manejador
		de nodos tipo cartaporte31:Autotransporte-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte31:TransporteMaritimo">
		<!--Manejador
		de nodos tipo cartaporte31:TransporteMaritimo-->
		<xsl:call-template name="Opcional">
			<xsl:with-param name="valor" select="./@PermSCT" />
		</xsl:call-template>
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte31:TransporteAereo">
		<!--Manejador
		de nodos tipo cartaporte31:TransporteAereo-->
		<xsl:call-template name="Requerido">
			<xsl:with-param name="valor" select="./@PermSCT" />
		</xsl:call-template>
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte31:TransporteFerroviario">
		<!--Manejador
		de nodos tipo cartaporte31:TransporteFerroviario-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte31:Carro">
		<!--Manejador
		de nodos tipo cartaporte31:Carro-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte31:FiguraTransporte">
		<!--Manejador
		de nodos tipo cartaporte31:FiguraTransporte-->
