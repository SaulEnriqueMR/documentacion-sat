...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="cartaporte:Ubicacion">
		<!--Manejador
		de nodos tipo cartaporte:Ubicacion-->
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:Mercancias">
		<!--Manejador
		de nodos tipo cartaporte:Mercancias-->
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:Mercancia">
		<!--Manejador
		de nodos tipo cartaporte:Mercancia-->
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:AutotransporteFederal">
		<!--Manejador
		de nodos tipo cartaporte:AutotransporteFederal-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte:TransporteMaritimo">
		<!--Manejador
		de nodos tipo cartaporte:TransporteMaritimo-->
		<xsl:call-template name="Opcional">
			<xsl:with-param name="valor" select="./@PermSCT" />
		</xsl:call-template>
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:TransporteAereo">
		<!--Manejador
		de nodos tipo cartaporte:TransporteAereo-->
		<xsl:call-template name="Requerido">
			<xsl:with-param name="valor" select="./@PermSCT" />
		</xsl:call-template>
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte:TransporteFerroviario">
		<!--Manejador
		de nodos tipo cartaporte:TransporteFerroviario-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte:Carro">
		<!--Manejador
		de nodos tipo cartaporte:Carro-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte:FiguraTransporte">
		<!--Manejador
		de nodos tipo cartaporte:FiguraTransporte-->
		<xsl:call-template name="Requerido">
	...
	<xsl:template match="cartaporte:Operador">
		<!--Manejador
		de nodos tipo cartaporte:Operador-->
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:Propietario">
		<!--Manejador
		de nodos tipo cartaporte:Propietario-->
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:Arrendatario">
		<!--Manejador
		de nodos tipo cartaporte:Arrendatario-->
		<xsl:call-template name="Opcional">
	...
	<xsl:template match="cartaporte:Notificado">
		<!--Manejador
		de nodos tipo cartaporte:Notificado-->
		<xsl:call-template name="Opcional">
