...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:donat="http://www.sat.gob.mx/donat"
  ...
  xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu"
  ...
  xmlns:spei="http://www.sat.gob.mx/spei" xmlns:nomina="http://www.sat.gob.mx/nomina"
  ...
  xmlns:cce="http://www.sat.gob.mx/ComercioExterior" xmlns:ine="http://www.sat.gob.mx/ine"
  ...
  <!-- 
	...
	-->
  <xsl:include href="complementos/estadocuentacombustible10.xslt" />
  <xsl:include href="complementos/estadocuentacombustible11.xslt" />
  <xsl:include href="complementos/estadocuentacombustible12.xslt" />
  <xsl:include href="complementos/prestadoresdeServiciosdecfd10.xslt" />
  <xsl:include href="complementos/donatarias11.xslt" />
  <xsl:include href="complementos/divisas10.xslt" />
  <xsl:include href="complementos/estadocuentabancario10.xslt" />
  <xsl:include href="complementos/detallista.xslt" />
  <xsl:include href="complementos/impouestoslocales10.xslt" />
  ...
  <xsl:include href="complementos/complemento_spei.xslt" />
  <xsl:include href="complementos/nomina11.xslt" />
  <xsl:include href="complementos/cfdiregistrofiscal10.xslt" />
  <xsl:include href="complementos/pagoenespecie10.xslt" />
  <xsl:include href="complementos/consumodecombustibles10.xslt" />
  <xsl:include href="complementos/valesdedespensa10.xslt" />
  <xsl:include href="complementos/aerolineas10.xslt" />
  <xsl:include href="complementos/notariospublicos10.xslt" />
  <xsl:include href="complementoconcepto/vehiculousado.xslt" />
  <xsl:include href="complementos/servicioparcialconstruccion.xslt" />
  <xsl:include href="complementos/certificadodedestruccion10.xslt" />
  <xsl:include href="complementos/renovacionysustitucionvehiculos.xslt" />
  <xsl:include href="complementos/obrasarteantiguedades10.xslt" />
  <xsl:include href="complementoconcepto/acreditamientoieps10.xslt" />
  <xsl:include href="complementos/estadocuentacombustible11.xslt" />
  <xsl:include href="complementos/comercioexterior10.xslt" />
  <xsl:include href="complementos/ine10.xslt" />
