...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:ecb="http://www.sat.gob.mx/ecb"
  ...
  xmlns:pago10="http://www.sat.gob.mx/Pagos" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11"
  ...
  <xsl:include href="complementos/impuestoslocales10.xslt" />
  ...
  <xsl:include href="complementos/ingresoshidrocarburos10.xslt" />
  <xsl:include href="complementos/cartaporte10.xslt" />
  ...
  <xsl:template match="cfdi:Concepto">
    ...
    <!-- Manejo de sub nodos de Retencion por cada una de los
    ...
    <!-- Manejo de los distintos sub nodos de información aduanera de forma indistinta a su grado de
    dependencia -->
