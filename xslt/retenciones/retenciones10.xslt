...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:planesderetiro="http://www.sat.gob.mx/esquemas/retencionpago/1/planesderetiro"
  ...
  <!-- 
	...
	-->
  <xsl:include href="complemento/arrendamientoenfideicomiso10.xslt" />
  <xsl:include href="complemento/dividendos10.xslt" />
  <xsl:include href="complemento/enajenaciondeacciones10.xslt" />
  <xsl:include href="complemento/fideicomisonoempresarial10.xslt" />
  <xsl:include href="complemento/intereses10.xslt" />
  <xsl:include href="complemento/intereseshipotecarios10.xslt" />
  <xsl:include href="complemento/pagosaextranjeros10.xslt" />
  <xsl:include href="complemento/planesderetiro10.xslt" />
  <xsl:include href="complemento/planesderetiro11.xslt" />
  <xsl:include href="complemento/premios10.xslt" />
  <xsl:include href="complemento/operacionesconderivados10.xslt" />
  <xsl:include href="complemento/sectorfinanciero10.xslt" />
